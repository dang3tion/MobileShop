              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="card">
                    <div class="card-body">
                      <div class=" mb-2">
                        <h4 class="text-center mt-3 mb-3">Phản hồi của khách hàng</h4>
                        <div class="row">
                        ...
                        <table id="bootstrap-data-table" class="table table-hover ">
                          ...
                          <tbody id="content-table">
                                    <tr>
                                      ...
                                      <td class="row" style="border: none;">
                                        <div style="margin: auto;">
                                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo"><i class="text-center fas fa-paper-plane"></i></button>

                                            <button  class="btn btn-danger sizeTh1"  data-toggle="modal" data-target="#delete" data-toggle="tooltip" data-placement="top" title="Xóa">
                                ...
                                <td>20/1/2019</td>
                                <td class="feedback">
                                  Admin cho e hỏi e mua Note 9 bản 3Gb-64 bây giờ em muốn đổi để lên cơn Note 9 Pro 6Gb-64 này thì bên cellphone thu mua con note 9 của em giá bao nhiêu ạ. E cảm ơn
                                </td>
                                <td class="row" style="border: none;">
                                  <div style="margin: auto;">
                                      <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo"><i class="text-center fas fa-paper-plane"></i></button>
