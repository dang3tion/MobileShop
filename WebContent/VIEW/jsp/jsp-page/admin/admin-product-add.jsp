...
<html lang="en">
  ...
  <head>
    ...
    <jsp:include
      page="/VIEW/jsp/jsp-component/head-css-admin.jsp"
    ></jsp:include>
    <link
...
/>
  ...
  <body>
    ...
    <div class="d-flex" id="wrapper">
      <!-- Sidebar -->
      <jsp:include
        page="/VIEW/jsp/jsp-component/sidebar-admin.jsp"
      ></jsp:include>
      <!--Nav-->
     ...
     <div id="page-content-wrapper">
      ...
      <div class="container mt-5 " style="width:95%">
        ...
        <form>
          <div class="row">
            <div class="col-6 space-top">
              ...
              <div class="input-group mb-2">
                ...
                <input type="text" class="form-control py-4" value="" placeholder="Nhập tên sản phẩm">
              </div>
            </div>
            <div class="col-6 space-top">
          ...
          <div class="row">
            <div class="col-6 space-top">
              ...
              <div class="input-group mb-2">
                ...
                <input type="text" class="form-control py-4" value="" placeholder="Nhập tên thương hiệu">
              </div>
            </div>
            <div class="col-6 space-top">
          ...
          <!-- add color -->
          <a  data-toggle="modal" data-target="#themMau" style="float: right;" name="1" class="btn icon-btn btn-success"
            href="#">
          ...
          <div class="row">
            <div class="col-6 space-top">
              ...
              <div class="input-group mb-2">
                ...
                <input type="text" class="form-control py-4" value="" placeholder="Nhập thông số màn hình">
              </div>
            </div>
            <div class="col-6 space-top">
              ...
              <div class="input-group mb-2">
                ...
                <input type="text" class="form-control py-4" value="" placeholder="Nhập tên hệ điều hành">
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-6 space-top">
              ...
              <div class="input-group mb-2">
                ...
                <input type="text" class="form-control py-4" value="" placeholder="Nhập thông số camera sau">
              </div>
            </div>
            <div class="col-6 space-top">
              ...
              <div class="input-group mb-2">
                ...
                <input type="text" class="form-control py-4" value="" placeholder="Nhập thông số camera trước">
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-6 space-top">
              ...
              <div class="input-group mb-2">
                ...
                <input type="text" class="form-control py-4" value="" placeholder="Nhập thông số CPU">
              </div>
            </div>
            <div class="col-6 space-top">
              ...
              <div class="input-group mb-2">
                ...
                <input type="text" class="form-control py-4" value="" placeholder="Nhập thông số bộ nhớ">
              </div>
            </div>
          </div>
          <div class="space-top">
          ...
          <a onclick="thongSoKt()"  style="float: right; color: white;" name="1" class="btn icon-btn btn-success">
          <span><i style="font-size: 1.2em;" class="fa fa-plus-circle" aria-hidden="true"></i></span>
         ...
         <div class="row" style="margin-top: 60px;">
          <input class="btn btn-primary col-sm-3 row space-top space-bottom " type="submit" value="Thêm sản phẩm">
        </div>
  ...
  <!-- /#wrapper -->
    <!-- Modal -->
<div class="modal fade" id="themMau" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
