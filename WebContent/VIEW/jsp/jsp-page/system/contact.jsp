    ...
    <div class="row">
      <div class="col-12">
        <div class="guide-buy">
          ...
          <p>Mobile Shop là một điểm đến mua sắm Online cho những khách hàng yêu quý những chiếc điện thoại thông minh.
          </p>
          <p>Sau đây chúng tôi xin hướng dẫn cho quý vị các bước mua hàng Online trên trang Web.
          </p>
          <div class="guide-frame">
            <div class="step">
              ...
              <div class="step">
                ...
                <p> + Bạn vui lòng cung cấp đầy đủ thông tin để phục vụ việc giao nhận hàng </p>
                <p> + Shop có 2 hình thức thanh toán để bạn lựa chọn : thanh toán trước qua thẻ ghi nợ quốc tế hoặc
              ...
              <div class="step">
                ...
                <p> + Bạn vui lòng giữ lại hóa đơn mua hàng để thực làm thủ tục bảo hành hoặc đổi trả sau này. </p>
                <p> + Đơn hàng của bạn sẽ được chúng tôi đóng gói và bàn giao cho đơn vị vận chuyển ngay sau khi nhận
                ...
                <div class="collumn">
                  <div class="form-2">
                    <div class="form-input-2">
                      ...
                      <input type="name" placeholder="Nhập tên của bạn" onfocusout="fullname(this,name3)">
                    </div>
                    <div class=" fillText3" id='name3'>
                    </div>
                  </div>
                </div>
                <div class="collumn">
                  <div class="alpha">
                    <div class="form-2">
                      <div class="form-input-2">
                        ...
                        <input type="email" placeholder="Nhập email" id="email" onfocusout="email(this,text2)">
                      </div>
                      <div class=" fillText3" id="text2">Email must have the @ characters
                      </div>
                    </div>
                  </div>
                  <div class="omega">
                    <div class="form-2">
                      <div class="form-input-2">
                        ...
                        <input class="input-2" type="text" outf placeholder="Nhập số điện thoại"
                          onfocusout="number(this,phone)">
                      </div>
                      <div class=" fillText3" id="phone">Only number input
                      </div>
                    </div>
                  </div>
                </div>
