...
<body >
    ...
    <div class="py-1 text-center">
      <img class="d-block mx-auto mb-4" src="${url}/image/img-sys/payment.png" alt="" width="72" height="72">
    ...
    <div class="row mt-5">
      <div class="col-md-4 order-md-2 mb-4">
        ...
        <div class="row" style="margin-top: 20px;">
          <form method="post" action="${pageContext.request.contextPath}/member/payment" style="margin: auto;">
            <button class="btn btn-primary" style="padding: 7px 130px;
