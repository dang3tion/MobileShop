	...
	<div class="container" style="margin: 60px auto; max-width: 80%;">
		<div class="py-1 text-center">
			<img class="d-block mx-auto mb-4"
				src="${url}/image/img-sys/payment.png" width="72" height="72">
				...
				<form class="needs-validation" action="../../Bill_Page/Bill.html"
					...
					<div class="d-block my-3">
						<div class="custom-control custom-radio">
							...
							required> <label class="custom-control-label" for="credit">Thanh
								toán Online</label>
						</div>
					...
					<div id="diaChiForm">
						<label for="cc-name">Địa chỉ</label> <input type="text"
							class="form-control" id="cc-name" placeholder="Nhập địa chỉ"
							required>
						<div class="invalid-feedback">Không được để trống</div>
						<hr class="mb-4">
					</div>
