				...
				<div class="filter-bar">
					<div class="filter-bar-frame">
							...
							<div class="filter-bar-select">
								<div class="check-select">
									<input onchange="sendAllUserSelected()" type="checkbox" value="android" name="android"
										id="f_android"> <label for=android>IOS </label>
								</div>
								<div class="check-select">
									<input onchange="sendAllUserSelected()" type="checkbox" value="ios" name="ios" id="ios">
						...
						<div class="filter-bar-card">
							...
							<div class="filter-bar-select">
								<div class="check-select">
									<input onchange="sendAllUserSelected()" type="checkbox" value="5inch" name="5inch" id="5inch">
								...
								<div class="check-select">
									<input onchange="sendAllUserSelected()" type="checkbox" value="5-6inch" name="5-6inch"
										id="5-6inch"> <label for=5-6inch>Vừa tay (5
										INCH đến 6 INCH) </label>
								</div>
								<div class="check-select">
									<input onchange="sendAllUserSelected()" type="checkbox" value="6inch" name="6inch" id="6inch">
						...
						<div class="filter-bar-card">
							...
							<div class="filter-bar-select">
								<div class="check-select">
									<input onchange="sendAllUserSelected()" type="checkbox" value="8g" name="8g" id="8g"> <label
										for="8g">Nhỏ hơn 8GB </label>
								</div>
								<div class="check-select">
									<input onchange="sendAllUserSelected()" type="checkbox" value="16-128g" name="16-128g"
										id="16-128g"> <label for="16-128g">16GB đến
										128GB </label>
								</div>
								<div class="check-select">
									<input onchange="sendAllUserSelected()" type="checkbox" value="256g" name="256g" id="256g">
									<label for="256g">256GB</label>
								</div>
								<div class="check-select">
									<input onchange="sendAllUserSelected()" type="checkbox" value="512g" name="512g" id="512g">
							...
							<div class="filter-bar-select">
								<div class="check-select">
									<input onchange="sendAllUserSelected()" type="checkbox" value="r-4g-down" name="r-4g-down"
										id="r-4g-down"> <label for="r-4g-down">Dưới
										4GB </label>
								</div>
								<div class="check-select">
									<input onchange="sendAllUserSelected()" type="checkbox" value="r-4g-6g" name="r-4g-6g"
										id="r-4g-6g"> <label for="r-4g-6g">4GB đến 6GB
									</label>
								</div>
								<div class="check-select">
									<input onchange="sendAllUserSelected()" type="checkbox" value="r-8g" name="r-8g" id="r-8g">
									<label for="r-8g">8GB </label>
								</div>
								<div class="check-select">
									<input onchange="sendAllUserSelected()" type="checkbox" value="r-12g-up" name="r-12g-up"
