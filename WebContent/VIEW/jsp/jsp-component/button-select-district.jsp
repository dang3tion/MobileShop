...
<select onchange="getWard(this.value)" class="mx-2"
	style="height: 38px; padding: 3px;position:static; outline: 0; border: 1px solid #b7b7b7; border-radius: 5px;"
	name="district" id="sehuyen" onfocusout="check_huyen(this.id)">
