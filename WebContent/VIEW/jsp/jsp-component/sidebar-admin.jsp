    ...
    pageEncoding="utf-8"%>
        ...
        <div class="side-bar bg-light border-right" id="sidebar-wrapper">
          ...
          <div class="list-group list-group-flush">
              <ul>
                  <li>
                      <a href="${pageContext.request.contextPath}/admin/index" class="list-group-item list-group-item-action  active"> Trang chủ <i
                  ...
                  <li>
                      <a href="${pageContext.request.contextPath}/admin/product" class="list-group-item list-group-item-action  "> Danh sách điện thoại
                  ...
                  <li>
                      <a href="${pageContext.request.contextPath}/admin/cancel-receipt" class="list-group-item list-group-item-action"> Đơn
                          hàng bị hủy <i class="menu-icon fas fa-phone-slash"></i></a>
                  </li>
                  <li>
                    <a href="${pageContext.request.contextPath}/admin/feedback" class="list-group-item list-group-item-action"> Phản hồi khách hàng <i class="menu-icon far fa-paper-plane"></i></a>
                </li>
    <li>
